/*
 * JUnit test case for bean TblAuthor
...
import org.demo.bean.TblAuthor ;
...
public class TblAuthorTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class TblAuthor getters and setters ..." );
		...
		tblAuthor.setAuthorid( integerValue ) ;
		Assert.assertTrue( integerValue == tblAuthor.getAuthorid() ) ;

		//--- Test setter/getter for field "authorname"  ( type : String )
		// System.out.println(" checking field authorname ..." );
		tblAuthor.setAuthorname( stringValue ) ;
		Assert.assertTrue( stringValue.equals( tblAuthor.getAuthorname() ) ) ;
