/*
 * JUnit test case for bean TblBook
...
public class TblBookTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class TblBook getters and setters ..." );
		
		TblBook tblBook = new TblBook();
		
		//--- Test setter/getter for field "bookid"  ( type : Integer )
		// System.out.println(" checking field bookid ..." );
		tblBook.setBookid( integerValue ) ;
		Assert.assertTrue( integerValue == tblBook.getBookid() ) ;

		//--- Test setter/getter for field "title"  ( type : String )
		// System.out.println(" checking field title ..." );
		tblBook.setTitle( stringValue ) ;
		Assert.assertTrue( stringValue.equals( tblBook.getTitle() ) ) ;

		//--- Test setter/getter for field "pubid"  ( type : Integer )
		// System.out.println(" checking field pubid ..." );
		tblBook.setPubid( integerValue ) ;
		Assert.assertTrue( integerValue == tblBook.getPubid() ) ;
